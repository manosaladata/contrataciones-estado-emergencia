...
mod_maps_module_ui<-function(id) {leafletOutput(NS(id,"map_mon"))}


# mod_maps_module_ui <- function(id){
#   ns <- NS(id)
#   tagList(
#  
#   )
...
#mod_maps_module_server <- function(input, output, session){
#   ns <- session$ns
#  
# }
